...
import 'package:duo_zui/ColumnsDetail.dart';
      ...
      child: Column(
        children: <Widget>[
          GestureDetector(
            child: Container(
              height: 50,
              child: ActivityTitleWidget(context, feedList[0].post.user.photo, feedList[0].post.user.nickname),
            ),
            onTap: (){
            ...
            child: Container(
              child:  Row(
                ...
                children: <Widget>[
                  ...
                  DescriptionLabel(context, feed.post.publishTime),
                ],
              ),
